...
function conf#editor#diffcolorscheme()
  hi DiffAdd      gui=none    guifg=NONE          guibg=GruvboxGreen
  hi DiffChange   gui=none    guifg=NONE          guibg=GruvboxAqua
  hi DiffDelete   gui=bold    guifg=GruvboxRed    guibg=GruvboxFg0
  hi DiffText     gui=none    guifg=NONE          guibg=GruvboxYellow
endfunction
