...
function conf#filetypes#python()
  ...
  au BufRead *.ipynb set filetype=python
...
function conf#filetypes#dbout()
  au BufRead *.dbout set filetype=dbout
  au FileType dbout set colorcolumn=
  au FileType dbout hi OverLength ctermbg=darkgray ctermfg=white guibg=darkgray
endfunction
